...
const airportData: Record<string, AirportData> = {
  'montpellier': {
    ...
    seoContent3: 'Tarif fixe Narbonne-Montpellier Aéroport : 200 - 220€ selon l\'adresse de départ. Pour les résidents des communes périphériques (Gruissan, Leucate, Sigean, etc.), des tarifs spécifiques sont disponibles sur demande. Disponible 24h/24, 7j/7, y compris les jours fériés. Réservation recommandée 24h à l\'avance pour les vols matinaux.',
    tips: ['Réservez 24h à l\'avance', 'Suivi vol en temps réel inclus', 'Attente gratuite si retard', 'Aide aux bagages incluse'],
    faq: [
      { q: 'Quel est le tarif du taxi Narbonne – Aéroport Montpellier ?', a: 'Le tarif fixe Narbonne centre – Aéroport Montpellier est de 200 - 220€. Ce tarif inclut les péages. Pour un devis précis selon votre adresse de départ, appelez le 07 68 30 33 03.' },
  ...
  'toulouse': {
    ...
    seoContent3: 'Tarif fixe Narbonne – Toulouse Blagnac : 350 - 370€ aller simple. Tous péages inclus, sans surprise. Pour les groupes (jusqu\'à 7 personnes), nos minivans offrent le maximum de confort. Réservation recommandée 48h à l\'avance pour les vols matinaux. Paiement CB ou espèces, facture disponible.',
    tips: ['Départ de nuit possible', 'Suivi vol Toulouse-Blagnac', 'Véhicule spacieux 7 places', 'Climatisation premium'],
    faq: [
      { q: 'Quel est le tarif taxi Narbonne – Toulouse Blagnac ?', a: 'Le tarif fixe Narbonne – Toulouse Blagnac est de 350 - 370€ aller simple, péages inclus. Pour un devis précis, contactez-nous au 07 68 30 33 03.' },
  ...
  'carcassonne': {
    ...
    seoContent2: 'ATC TAXI VTC Narbonne propose des transferts vers Carcassonne Aéroport en seulement 45 minutes de trajet par l\'A61. Tarif fixe : 130 - 150€ depuis Narbonne centre, péages inclus. Service disponible 24h/24 avec suivi de vol en temps réel. Nos chauffeurs connaissent parfaitement l\'aéroport CCF et ses différents terminaux.',
    ...
    faq: [
      { q: 'Quel est le tarif taxi Narbonne – Aéroport de Carcassonne ?', a: 'Le tarif fixe Narbonne – Aéroport Carcassonne (CCF) est de 130 - 150€, péages inclus. Appelez le 07 68 30 33 03 pour un devis selon votre adresse.' },
  ...
  'beziers': {
    ...
    seoContent2: 'ATC TAXI VTC Narbonne propose des transferts vers Béziers Aéroport depuis Narbonne et toute la région. Service particulièrement adapté pour les vols saisonniers vers les îles britanniques et l\'Europe du Nord. Tarif fixe : 80 - 100€ depuis Narbonne, péages inclus. Disponible 24h/24.',
  ...
  'barcelone': {
    ...
    seoContent2: 'ATC TAXI VTC Narbonne propose des transferts directs vers l\'aéroport BCN depuis Narbonne et toute l\'Aude. Notre chauffeur francophone gère les péages autoroutiers (A9, AP-7) et le passage de la frontière franco-espagnole. Tarif fixe tout compris (péages) : 580 - 600€ selon l\'adresse de départ. Pas de compteur, pas de surprise.',
