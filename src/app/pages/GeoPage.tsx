...
const cityData: Record<string, CityData> = {
  'gruissan': {
    ...
    faq: [
      { q: 'Combien coûte un taxi Narbonne – Gruissan ?', a: 'Le tarif Narbonne – Gruissan est d\'environ 30-35€ selon l\'adresse exacte et l\'horaire. Contactez-nous pour un devis précis au 07 68 30 33 03.' },
  ...
  'leucate': {
    city: 'Leucate', dept: 'Aude (11)', distance: '40 km', duration: '30 min',
  ...
  'sigean': {
    ...
    faq: [
      { q: 'Taxi pour la Réserve Africaine de Sigean ?', a: 'Oui, nous assurons les transferts vers la Réserve Africaine de Sigean. Tarif depuis Narbonne : environ 30 - 35€. Nous pouvons vous attendre sur place si vous souhaitez un aller-retour.' },
      { q: 'Taxi Sigean depuis la gare de Narbonne ?', a: 'Oui, dépose à Sigean depuis la gare SNCF de Narbonne. Disponible 24h/24 au 07 68 30 33 03. Tarif estimé : 30 - 35€.' },
  ...
  'peyriac-de-mer': {
    city: 'Peyriac-de-Mer', dept: 'Aude (11)', distance: '14 km', duration: '22 min',
    ...
    faq: [
      { q: 'Taxi pour l\'étang de Bages depuis Narbonne ?', a: 'Oui, Peyriac-de-Mer est à 14 km de Narbonne. Tarif environ 30-40€. Parfait pour une excursion naturaliste ou touristique.' },
  ...
  'carcassonne': {
    ...
    faq: [
      { q: 'Quel est le tarif d\'un taxi Narbonne – Carcassonne ?', a: 'Le trajet Narbonne–Carcassonne coûte environ 120-130€ aller simple. Demandez un devis précis au 07 68 30 33 03.' },
      { q: 'Taxi Narbonne – Aéroport de Carcassonne ?', a: 'Oui, transfert vers l\'aéroport Carcassonne (CCF). Tarif fixe ~130€ depuis Narbonne. Suivi de vol inclus, attente gratuite si retard.' },
  ...
  'beziers-cap-dagde': {
    ...
    faq: [
      { q: 'Prix du taxi Narbonne – Béziers ?', a: 'Le trajet coûte environ 65-75€. Pour l\'aéroport de Béziers, comptez 80-100€ selon l\'adresse de départ.' },
      ...
      { q: 'Taxi Narbonne – Aéroport Béziers ?', a: 'Transfert disponible. Tarif depuis Narbonne : 80-100€. Suivi de vol inclus. Appelez le 07 68 30 33 03 ou WhatsApp.' },
    ],
  },
  'narbonne-barcelone': {
    city: 'Barcelone', dept: 'Espagne', distance: '250 km', duration: '2h30',
    ...
    faq: [
      { q: 'Quel est le prix d\'un taxi Narbonne – Barcelone ?', a: 'Le tarif Narbonne – Barcelone est d\'environ 580-600€ aller simple, tout compris (péages). Contactez-nous pour un devis précis selon votre destination exacte.' },
      ...
      { q: 'Taxi depuis Narbonne vers l\'aéroport de Barcelone El Prat ?', a: 'Oui, transfert direct vers l\'aéroport BCN de Barcelone. Tarif ~580-600€. Suivi de votre vol, panneau nominatif à l\'arrivée si besoin.' },
  ...
  'reserve-africaine-sigean': {
    city: 'Réserve Africaine Sigean', dept: 'Aude (11)', distance: '18 km', duration: '25 min',
    heroImage: 'https://images.unsplash.com/photo-1759031218375-63726471d975?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Taxi depuis Narbonne vers la Réserve Africaine ?', a: 'Oui ! 20 km depuis Narbonne, environ 25 minutes. Tarif ~ 40-50€. Réservez au 07 68 30 33 03.' },
  ...
  'narbonne-plage': {
    ...
    faq: [
      { q: 'Combien coûte un taxi Narbonne – Narbonne Plage ?', a: 'Le trajet Narbonne centre – Narbonne Plage coûte environ 40-50€ selon l\'adresse exacte et l\'horaire. Contactez-nous pour un devis précis.' },
  ...
  'argeliers': {
    city: 'Argeliers', dept: 'Aude (11)', distance: '20 km', duration: '25 min',
    heroImage: 'https://images.unsplash.com/photo-1760372059338-b503bfd850df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Taxi Argeliers – Narbonne, quel tarif ?', a: 'Argeliers est à environ 20 km de Narbonne. Tarif estimé : 45-50€. Appelez le 07 68 30 33 03 pour un devis précis.' },
  ...
  'ginestas': {
    city: 'Ginestas', dept: 'Aude (11)', distance: '17 km', duration: '30 min',
    heroImage: 'https://images.unsplash.com/photo-1761125263507-0b8d8bfb8337?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Quel est le prix d\'un taxi depuis Ginestas vers Narbonne ?', a: 'Ginestas est à environ 17 km de Narbonne. Tarif estimé : 40-45€. Contactez-nous au 07 68 30 33 03 pour un devis gratuit.' },
  ...
  'bize-minervois': {
    city: 'Bize-Minervois', dept: 'Aude (11)', distance: '22 km', duration: '35 min',
    ...
    faq: [
      { q: 'Taxi Bize-Minervois – Narbonne, combien ?', a: 'Bize-Minervois est à environ 22 km de Narbonne. Tarif estimé : 50-60€. Appelez le 07 68 30 33 03 pour un devis gratuit.' },
  ...
  'cuxac-daude': {
    city: 'Cuxac-d\'Aude', dept: 'Aude (11)', distance: '8 km', duration: '15 min',
    heroImage: 'https://images.unsplash.com/photo-1761125263507-0b8d8bfb8337?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Prix taxi Cuxac-d\'Aude – Narbonne ?', a: 'Cuxac-d\'Aude est à seulement 8 km de Narbonne. Tarif estimé : 20-25€ selon l\'adresse. Contactez-nous au 07 68 30 33 03.' },
  ...
  'vinassan': {
    ...
    faq: [
      { q: 'Taxi Vinassan – Narbonne, quel prix ?', a: 'Vinassan est à 8 km de Narbonne. Tarif estimé : 20-25€. Appelez le 07 68 30 33 03 pour un devis immédiat.' },
  ...
  'armissan': {
    city: 'Armissan', dept: 'Aude (11)', distance: '10 km', duration: '18 min',
    heroImage: 'https://images.unsplash.com/photo-1697464960895-7979baf9e029?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Prix taxi Armissan – Narbonne ?', a: 'Armissan est à 10 km de Narbonne. Tarif estimé : 25-30€. Contactez-nous au 07 68 30 33 03.' },
  ...
  'bages': {
    city: 'Bages', dept: 'Aude (11)', distance: '10 km', duration: '10 min',
    ...
    faq: [
      { q: 'Taxi Narbonne – Bages, combien ça coûte ?', a: 'Bages est à seulement 10 km de Narbonne. Tarif estimé : 25-30€. Appelez le 07 68 30 33 03.' },
  ...
  'le-somail': {
    city: 'Le Somail', dept: 'Aude (11)', distance: '14 km', duration: '25 min',
    heroImage: 'https://images.unsplash.com/photo-1645390841042-77720e06e2b9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400',
    ...
    faq: [
      { q: 'Taxi depuis Narbonne vers Le Somail ?', a: 'Le Somail est à 14 km de Narbonne sur le Canal du Midi. Tarif estimé : 35-40€. Réservez au 07 68 30 33 03.' },
